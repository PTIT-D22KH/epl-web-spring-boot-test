...
public class AuthController {
    ...
    public ResponseEntity<ResponseLoginDTO> getRefreshToken(
            @CookieValue(name = "refresh_token", defaultValue = "abc") String refresh_token) throws InvalidRequestException {
    ...
    public ResponseEntity<Void> logout() throws InvalidRequestException {
        ...
        if (email.equals("email")) {
            throw new InvalidRequestException("Access Token không hợp lệ");
        }
